...
```{r}
mc4 <- read.csv("Data/acclima_raw/DataSnapExport_090820181200_datasnap3_mc4.csv")
mc3 <- read.csv("Data/acclima_raw/DataSnapExport_090820181246_datasnap1_mc3.csv")
mc1 <- read.csv("Data/acclima_raw/DataSnapExport_090820181012_datasnap2_mc1.csv")
...
ggplot(acclima_total[which(acclima_total$time > "2018-05-26 12:00:00"), ]) +
  aes(x=time, y=moisture, color=depth_cm) +
  geom_point(size = 1) +
  xlab("Time") + ylab("Soil moisture (volumetric)") + #+ ggtitle("Soil moisture") +
  theme_bw() +
  theme(axis.text = element_text(size = 15),
        axis.title = element_text(size = 15),
        panel.grid.major = element_blank(),
