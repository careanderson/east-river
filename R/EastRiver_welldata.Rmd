...
colnames(mct2_water) <- make.unique(names(mct2_water)) #have to run this because there are multiple "sd" column names

mct2_water <- mct2_water %>%
...
## Figures
```{r}
ggplot(subset(mct2_water[which(mct2_water$Date < "2018-08-10 12:00:00"), ], depth %in% "D" & position_mct2 %in% c(1,3,4))) +
  aes(x=Date, y=Fe) +
...
w1 <- ggplot(subset(mct2_water[which(mct2_water$Date < "2018-08-10 12:00:00"), ], depth %in% "D" & position_mct2 %in% c(1,3,4))) +
  aes(x=Date, y=NPOC) +
  geom_point() + geom_smooth() +
  ylab("NPOC (mM)") +
  facet_wrap(~position_mct2) +
...
w2 <- ggplot(subset(mct2_water[which(mct2_water$Date < "2018-08-10 12:00:00"), ], depth %in% "D" & position_mct2 %in% c(1,3,4))) +
  aes(x=Date, y=SO4) +
  geom_point() + geom_smooth() +
  ylab("SO4 (mM)") +
  facet_wrap(~position_mct2) +
...
w3 <- ggplot(subset(mct2_water[which(mct2_water$Date < "2018-08-10 12:00:00"), ], depth %in% "D" & position_mct2 %in% c(1,3,4))) +
  aes(x=Date, y=Fe) +
  geom_point() + geom_smooth() +
  ylab("Fe (M)") +
  facet_wrap(~position_mct2) +
...
w4 <- ggplot(subset(mct2_water[which(mct2_water$Date < "2018-08-10 12:00:00"), ], depth %in% "D" & position_mct2 %in% c(1,3,4))) +
  aes(x=Date, y=Mn) +
  geom_point() + geom_smooth() +
  ylab("Mn (M)") +
  facet_wrap(~position_mct2) +
