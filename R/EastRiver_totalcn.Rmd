...
er_redo <- read.table("Data/EA_Data/CA_180920.txt", sep="\t")[-(1:2),] #Mariela re-ran these samples Sept 2018
...
er_redo$sample_id <- c("standard", "standard", "standard", "standard", "bypass", "31-1", "31-2", "27-1", "27-2", "60-1", "60-2", "40-1", "40-2", "blank")
