...
rhizon_total$water_mol_co2 <- (rhizon_total$conc * 1*10^-6) * rhizon_total$water_L
rhizon_total$air_mol_co2 <- (rhizon_total$conc * 1*10^-6) * (12 - rhizon_total$water_L)

rhizon_total$total_mol_co2 <- rhizon_total$water_mol_co2 + rhizon_total$air_mol_co2
rhizon_total$doc_aq <- rhizon_total$total_mol_co2 / rhizon_total$water_L
...
```{r}
ggplot(rhizon_total) +
  aes(x=date, y=doc_aq, color=as.factor(mct2_position)) +
  geom_point() +
#  geom_smooth() +
