...
dens.frac.merge$light_frac_per <- dens.frac.merge$light_frac_g / dens.frac.merge$soil_mass_g
dens.frac.merge$int_frac_per <- dens.frac.merge$int_frac_g / dens.frac.merge$soil_mass_g
dens.frac.merge$heavy_frac_per <- dens.frac.merge$heavy_frac_g / dens.frac.merge$soil_mass_g
