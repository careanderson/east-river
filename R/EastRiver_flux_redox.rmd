...
ggplot(flux_total[which(flux_total$datetime < "2018-08-10 12:00:00"), ]) +
  aes(x=datetime, y=flux.av) +
  geom_point() +
  geom_smooth() +
  ylab("Soil respiration (CO2 flux)") +
...
ggplot(rhiz_toc_av[which(rhiz_toc_av$date < "2018-08-10 12:00:00"), ]) +
  aes(x=date, y=TOC_mean, color=depth_class) +
...
ggplot(rhiz_icp_av[which(rhiz_icp_av$date < "2018-08-10 12:00:00"), ]) +
  aes(x=date, y=Fe_mean, color=depth_class) +
  geom_point() + geom_line() +
  ylab("Fe (M)") +
  guides(color=guide_legend(title="Soil depth (cm)")) +
  facet_wrap(~position_mct2) +
...
ggplot(rhiz_icp_av[which(rhiz_icp_av$date < "2018-08-10 12:00:00"), ]) +
  aes(x=date, y=SO4_mean, color=depth_class) +
  geom_point() + geom_line() +
  ylab("SO4 (mM)") +
  guides(color=guide_legend(title="Soil depth (cm)")) +
  facet_wrap(~position_mct2) +
...
ggplot(acclima_av[which(acclima_av$date > "2018-05-27 12:00:00"), ]) +
  aes(x=date, y=moisture_mean, color=depth_cm) +
  geom_point(size = 1) +
  xlab("Time") + ylab("Soil moisture (volumetric)") +
  guides(color=guide_legend(title="Soil depth (cm)")) +
  facet_wrap(~location) +
  theme_bw() +
  theme(axis.text.y = element_text(size = 33),
